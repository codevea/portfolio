		...
		<ul>
			...
			<li>
				<div>
					...
					<p class="lineBarreDeux"></p>
					<h3>Codevea Auto-entrepreneur</h3>
			...
			<li>
				<div>
					...
					<p class="lineBarreDeux"></p>
					<h3>Entreprise individuelle agricole</h3>
